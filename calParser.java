...
public class calParser extends Parser {
	...
	public static final int
		CompOp=1, Assign=2, Print=3, OpenBracket=4, CloseBracket=5, Multiply=6, 
		Semicolon=7, Divide=8, Plus=9, Minus=10, Comma=11, Colon=12, Equals=13, 
		And=14, NotEqual=15, LessThan=16, LessOrEqualTo=17, GreaterThan=18, GreaterThanOrEqualTo=19, 
		Tilde=20, Variable=21, Constant=22, Begin=23, End=24, Integer=25, True=26, 
		False=27, If=28, Is=29, Return=30, Void=31, Boolean=32, Else=33, While=34, 
		Skip=35, Main=36, ID=37, Number=38, WS=39;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "CompOp", "Assign", "Print", "OpenBracket", "CloseBracket", "Multiply", 
			"Semicolon", "Divide", "Plus", "Minus", "Comma", "Colon", "Equals", "And", 
			"NotEqual", "LessThan", "LessOrEqualTo", "GreaterThan", "GreaterThanOrEqualTo", 
			"Tilde", "Variable", "Constant", "Begin", "End", "Integer", "True", "False", 
			"If", "Is", "Return", "Void", "Boolean", "Else", "While", "Skip", "Main", 
			"ID", "Number", "WS"
		};
	}
	...
	public static class FunctionContext extends ParserRuleContext {
		...
		public TerminalNode ID() { return getToken(calParser.ID, 0); }
		public List<TerminalNode> OpenBracket() { return getTokens(calParser.OpenBracket); }
		public TerminalNode OpenBracket(int i) {
			return getToken(calParser.OpenBracket, i);
		}
		public Parameter_listContext parameter_list() {
			return getRuleContext(Parameter_listContext.class,0);
		}
		public TerminalNode CloseBracket() { return getToken(calParser.CloseBracket, 0); }
	...
	public final TypeContext type() throws RecognitionException {
		...
		try {
			...
			setState(87);
			_la = _input.LA(1);
			if ( !(((_la) & ~0x3f) == 0 && ((1L << _la) & 6476005376L) != 0) ) {
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public TerminalNode OpenBracket() { return getToken(calParser.OpenBracket, 0); }
